...
class KakaotalkDataset(ChatDatasetBase):
    def __init__(self, path_data, path_prefix, n_vocab, is_augment, augment_topn, augment_threshold, speaker):
        # base initialization
        super().__init__(path_data, path_prefix, n_vocab, is_augment, augment_topn, augment_threshold)
